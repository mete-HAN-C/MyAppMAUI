...
public class AddActivityEventPage : ContentPage
{
    public AddActivityEventPage()
    {
            ...
            Children =
            {
                new VerticalStackLayout()
                {
                    ...
                    Children =
                    {
                        ...
                        CreateInputGroup("Etkinlik Adı"),
                        CreateInputGroup("Açıklama"),
